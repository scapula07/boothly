...
export default function EventDetails() {
  return (
    <div className="min-h-screen bg-white">
      {/* Top Bar */}
      <div className="w-full bg-[#7C3AED] py-4 flex items-center justify-center">
      ...
      <div className="max-w-3xl mx-auto px-4 pt-8 pb-16">
        ...
        <div className="flex gap-4 justify-center mb-8">
          <button className="bg-[#7C3AED] text-white px-8 py-2 rounded-full font-medium flex items-center gap-2"><svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6 0a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>View</button>
          <button className="bg-[#7C3AED] text-white px-8 py-2 rounded-full font-medium">Select</button>
          <button className="bg-[#7C3AED] text-white px-8 py-2 rounded-full font-medium flex items-center gap-2"><svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M4 12h16M4 18h16" /></svg>Menu</button>
        </div>
        {/* No uploads message */}
