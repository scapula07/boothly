  ...
  return (
    <footer id={id} className="w-full bg-[#F3F4F7]">
      <div className="max-w-7xl mx-auto px-4 py-8 sm:py-12">
        {/* Top brand */}
        <div className="text-xl sm:text-2xl font-extrabold text-gray-900 mb-4">Boothly</div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="sm:col-span-2 text-center sm:text-left">
            ...
            <ul className="grid grid-cols-2 sm:grid-cols-3 gap-y-2 gap-x-4 text-gray-600 max-w-md mx-auto sm:mx-0">
              {quickLinks.map((link) => (
                <li key={link} className="hover:text-gray-900 cursor-pointer text-sm sm:text-base">
                  {link}
                </li>
              ))}
            </ul>
          ...
          <div className="flex flex-col gap-4 justify-between text-center sm:text-left">
            <div>
              ...
              <p className="text-gray-600 text-sm sm:text-base">+1 891 989-11-91</p>
              <p className="text-gray-600 text-sm sm:text-base">help@gwid.io</p>
            </div>
            <div className="flex items-center gap-3 justify-center sm:justify-start">
              {[
                ...
                <div key={icon.name} className="w-8 sm:w-9 h-8 sm:h-9 rounded-full bg-white flex items-center justify-center shadow border border-gray-200 hover:shadow-md transition-shadow">
                  <svg className="w-3 h-3 sm:w-4 sm:h-4 text-gray-600" viewBox="0 0 24 24" fill="currentColor">
                    <path d={icon.path} />
                  </svg>
                </div>
              ))}
